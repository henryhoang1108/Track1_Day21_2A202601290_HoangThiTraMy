...
| 2 | **P2. Human Baseline & Agreement** | Phân tích tỉ lệ đồng thuận (% agreement) và tổng hợp 6 cases bất đồng từ 3 file nhãn cá nhân. | Chạy script Python `eval/agreement.py` kiểm chứng số liệu (Bình 80%, My 84%, Vinh 84%, tổng 76%). |
...
| 7 | **P7. Verdict & Class Pitch** | Gợi ý cấu trúc báo cáo PM 1 trang và kịch bản thuyết trình 2 phút trước lớp. | Tự ra quyết định Gate **HOLD / CHƯA SHIP**, viết bộ câu hỏi phản biện. |
